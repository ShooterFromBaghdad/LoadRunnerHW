...
/*Correlation comment - Do not change!  Original value='129243.42980964zztHQfipQcAiDDDDDQiiHpHfDfcf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("tr_main_login_itinerary", LR_AUTO);

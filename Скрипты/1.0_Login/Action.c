...
///*Correlation comment - Do not change!  Original value='129222.510085055zztziicpizcfDQiiVpcQHVHf' Name ='userSession' Type ='ResponseBased'*/
...
//		LAST);
	...
	lr_end_transaction("tr_main_login", LR_AUTO);
